...
![image](https://github.com/user-attachments/assets/a0051baf-e2ff-4cd7-8c6a-a4ffeee3bcbe)
...
![image](https://user-images.githubusercontent.com/63351166/220417360-b476ab40-bc32-457f-9d8e-7ab16894c85b.png)
...
📦SpeedSmm_V2
 ...
 ┃ ┃ ┃ ┃ ┣ 📂images
 ┃ ┃ ┃ ┃ ┃ ┣ 📂button_builder
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜colorpicker_overlay.html
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜colorpicker_select.html
 ┃ ┃ ┃ ┃ ┃ ┗ 📂tree
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜32px.html
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜40px.html
 ┃ ┃ ┃ ┃ ┣ 📂vendors
 ...
 ┃ ┃ ┃ ┃ ┣ 📂admin
 ┃ ┃ ┃ ┃ ┃ ┣ 📜api_balance.ejs
 ┃ ┃ ┃ ┃ ┃ ┣ 📜balance_load_admin.ejs
 ┃ ┃ ┃ ┃ ┃ ┣ 📜orders_admin.ejs
 ┃ ┃ ┃ ┃ ┃ ┗ 📜statistics_admin.ejs
 ┃ ┃ ┃ ┃ ┣ 📜balance_load.ejs
 ┃ ┃ ┃ ┃ ┣ 📜change_pass.ejs
 ┃ ┃ ┃ ┃ ┣ 📜change_username.ejs
 ┃ ┃ ┃ ┃ ┣ 📜my_orders.ejs
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜pattern-8.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜pattern-9.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜service-pattern-3.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜service-pattern-4.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜service-pattern.png
 ┃ ┃ ┃ ┃ ┃ ┗ 📜team-pattern.png
 ┃ ┃ ┃ ┃ ┣ 📂clients
 ┃ ┃ ┃ ┃ ┃ ┣ 📜1.png
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜8.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜9.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜footer-gallery-thumb-1.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜footer-gallery-thumb-2.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜footer-gallery-thumb-3.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜footer-gallery-thumb-4.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜footer-gallery-thumb-5.jpg
 ┃ ┃ ┃ ┃ ┃ ┗ 📜footer-gallery-thumb-6.jpg
 ┃ ┃ ┃ ┃ ┣ 📂icons
 ┃ ┃ ┃ ┃ ┃ ┣ 📜about.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜banner-curve.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜banner-icon-1.png
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜service-pattern-2.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜testimonial-1.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜testimonial-2.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜testimonial-3.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜testimonial-icon.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜testimonial-paroller.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜tick.png
 ┃ ┃ ┃ ┃ ┃ ┗ 📜waves-shape.png
 ┃ ┃ ┃ ┃ ┣ 📂resource
 ┃ ┃ ┃ ┃ ┃ ┣ 📂products
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜seo.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜service.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜social-media-marketing-vector-illustration.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜step-1.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜step-2.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜team-1.jpg
 ┃ ┃ ┃ ┃ ┃ ┣ 📜team-2.jpg
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜palette-gradient.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜palette-noui.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜palette-noui.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜palette-variables.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜palette-variables.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📂menu
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📂menu-types
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜horizontal-menu.css
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜hex2rgb.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜main-menu-mixin.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜main-menu-mixin.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜transitions.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜transitions.min.css
 ┃ ┃ ┃ ┃ ┣ 📂pages
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat-list.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat-list.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-details.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-details.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-email.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-email.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-file-manager.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-file-manager.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-list.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-list.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-print.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-print.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-kanban.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜app-kanban.min.css
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜dashboard-ecommerce.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-create-app.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-create-app.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-blog.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-blog.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-coming-soon.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-coming-soon.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-faq.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-faq.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-knowledge-base.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-knowledge-base.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-misc.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-misc.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-pricing.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-pricing.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-profile.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜page-profile.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📜ui-feather.css
 ┃ ┃ ┃ ┃ ┃ ┗ 📜ui-feather.min.css
 ┃ ┃ ┃ ┃ ┣ 📂plugins
 ┃ ┃ ┃ ┃ ┃ ┣ 📂charts
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜chart-apex.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📂extensions
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-context-menu.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-context-menu.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-drag-drop.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-drag-drop.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-media-player.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-media-player.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-ratings.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-ratings.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sliders.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sliders.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sweet-alerts.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sweet-alerts.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-swiper.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-swiper.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-toastr.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-toastr.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tour.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tour.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tree.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜ext-component-tree.min.css
 ┃ ┃ ┃ ┃ ┃ ┣ 📂forms
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📂pickers
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-flat-pickr.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-flat-pickr.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-pickadate.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜form-pickadate.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-file-uploader.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-file-uploader.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-number-input.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-number-input.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-quill-editor.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-quill-editor.min.css
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-validation.css
 ...
 ┃ ┃ ┃ ┃ ┃ ┣ 📜logout.PNG
 ┃ ┃ ┃ ┃ ┃ ┣ 📜register.PNG
 ┃ ┃ ┃ ┃ ┃ ┣ 📜sanctum-get-user-api.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜sanctum-login-api.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜sanctum-logout-api.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜sanctum-register-api.jpg
 ┃ ┃ ┃ ┃ ┃ ┗ 📜user.PNG
 ┃ ┃ ┃ ┃ ┣ 📂elements
 ┃ ┃ ┃ ┃ ┃ ┣ 📜apple-watch.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜beats-headphones.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜decore-left.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜decore-right.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜homepod.png
 ┃ ┃ ┃ ┃ ┃ ┣ 📜ipad-pro.png
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜card-advance.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜card-analytics.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜card-analytics.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜card-statistics.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜card-statistics.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂charts
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜chart-apex.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜chart-apex.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜chart-chartjs.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜chart-chartjs.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂components
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-accordion.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-accordion.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-alerts.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-alerts.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-bs-toast.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-bs-toast.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-dropdowns.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-dropdowns.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-modals.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-modals.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-navs.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-navs.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-popovers.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-popovers.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜components-tooltips.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜components-tooltips.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂extensions
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-blockui.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-blockui.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-clipboard.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-clipboard.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-context-menu.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-context-menu.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-drag-drop.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-drag-drop.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-i18n.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-i18n.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-media-player.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-media-player.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-ratings.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-ratings.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sliders.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sliders.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sweet-alerts.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-sweet-alerts.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-swiper.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-swiper.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-toastr.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-toastr.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tour.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tour.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ext-component-tree.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜ext-component-tree.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂forms
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📂pickers
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-pickers.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜form-pickers.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-file-uploader.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-file-uploader.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-input-mask.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-input-mask.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-number-input.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-number-input.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-quill-editor.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-quill-editor.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-repeater.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-repeater.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-select2.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-select2.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-tooltip-valid.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-tooltip-valid.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜form-validation.js
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-access-permission.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-access-roles.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-access-roles.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar-events.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar-events.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-calendar.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-chat.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-checkout.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-checkout.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-details.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-details.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-wishlist.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce-wishlist.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-ecommerce.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-email.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-email.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-file-manager.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-file-manager.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-list.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-list.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-print.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice-print.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-invoice.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-kanban.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-kanban.min.js
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-todo.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-list.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-list.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-account.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-account.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-billing.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-billing.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-security.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view-security.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜app-user-view.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-forgot-password.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-forgot-password.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-login.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-login.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-register.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-register.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-reset-password.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-reset-password.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-two-steps.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜auth-two-steps.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜dashboard-analytics.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜dashboard-analytics.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜dashboard-ecommerce.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜dashboard-ecommerce.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-new-address.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-new-address.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-new-cc.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-new-cc.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-permission.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-permission.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-role.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-add-role.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-create-app.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-create-app.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-cc.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-cc.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-permission.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-permission.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-user.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-edit-user.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-share-project.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-share-project.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-two-factor-auth.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜modal-two-factor-auth.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-account.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-account.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-billing.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-billing.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-security.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-account-settings-security.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-api-key.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-api-key.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-blog-edit.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-blog-edit.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-knowledge-base.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-knowledge-base.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-pricing.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-pricing.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜page-profile.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜page-profile.min.js
 ...
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜components-pagination.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂tables
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜table-datatables-advanced.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜table-datatables-advanced.min.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜table-datatables-basic.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜table-datatables-basic.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📂ui
 ┃ ┃ ┃ ┃ ┃ ┃ ┣ 📜ui-feather.js
 ┃ ┃ ┃ ┃ ┃ ┃ ┗ 📜ui-feather.min.js
 ┃ ┃ ┃ ┃ ┃ ┣ 📜customizer.js
